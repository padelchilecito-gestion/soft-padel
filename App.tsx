                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input 
                                        type="number" 
                                        min="0"
                                        value={config.mpFeePercentage || 0} 
                                        onChange={(e) => onUpdateConfig({...config, mpFeePercentage: parseFloat(e.target.value)})}
                                        className="w-full bg-slate-800 border border-white/10 rounded-lg py-3 pl-10 text-white font-mono placeholder-slate-600 focus:ring-2 focus:ring-purple-500"
                                    />
                                </div>
                                <p className="text-[10px] text-slate-500 mt-1 ml-1">Se agregará este porcentaje al total en pagos con QR.</p>
                            </div>
                        </div>
